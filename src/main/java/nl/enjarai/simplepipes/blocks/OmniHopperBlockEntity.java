...
//        ItemStack itemStack2 = transfer(null, inventory, itemStack, null);
    ...
    private static ItemStack transfer(@Nullable Inventory from, Inventory to, ItemStack stack, int slot, @Nullable Direction side) {
        ...
        if (canInsert(to, stack, slot, side)) {
            ...
            if (bl) {
                if (bl2 && to instanceof net.minecraft.block.entity.HopperBlockEntity) {
                    net.minecraft.block.entity.HopperBlockEntity hopperBlockEntity = (net.minecraft.block.entity.HopperBlockEntity)to;
